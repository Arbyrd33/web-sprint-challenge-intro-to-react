...
- [ ] Render your characters to the DOM:
  ...
  x 1. Build a React component named 'Character' to render an individual character.
  x 1. Map over the list in state, and for each character render a Character to the page.
  x 1. Each rendered character must display its name in the DOM (e.g. "Luke Skywalker").
  x 1. The character's name can't be hard-coded into the HTML. This data must be obtained from the API.
